...
public class PrincipalController implements Initializable {
   ...
   @FXML
    private void abrirClienteCadastrado(ActionEvent event) throws IOException {
    ...
    @FXML
    private void abrilClienteNaoCadastrado(ActionEvent event) throws IOException  {
         //Código para abrir uma nova Janela
        //Ler o FXML que representa a nova janela
        //(adicionar o throws)
        Parent root = FXMLLoader.load(getClass()
                .getResource("/ui/ClientesNaoCadastrados/CadastrarClientes.fxml"));
        //Criando a cena
        Scene scene = new Scene(root);
        //Criando a janela (STAGE) 
        Stage stage = new Stage(StageStyle.UTILITY);
